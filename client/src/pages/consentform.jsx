...
const App = () => {
  ...
  const getDepartmentConsentText = (dept) => {
    const textMap = {
      'Oral Medicine and Radiology': {
        intro: 'வாய்வழி மருத்துவம் மற்றும் கதிரியக்கவியல் (Oral Medicine & Radiology) பிரிவு',
        dept1: 'வாய்வழி மருத்துவத்துறையின்',
        dept2: 'பல்',
        dept3: 'வாய்வழி மருத்துவக் குழுவை'
      },
      'Pedodontics': {
        intro: 'குழந்தைகள் பல் மருத்துவப் (Pedodontics) பிரிவு',
        dept1: 'குழந்தைகள் பல் மருத்துவத்துறையின்',
        dept2: 'குழந்தைகள் பல்',
        dept3: 'குழந்தைகள் பல் மருத்துவக் குழுவை'
      },
      'Implantology': {
        intro: 'பல் இம்ப்ளான்டாலஜி (Implantology) பிரிவு',
        dept1: 'பல் இம்ப்ளான்டாலஜி துறையின்',
        dept2: 'பல் இம்ப்ளான்ட்',
        dept3: 'பல் இம்ப்ளான்டாலஜி குழுவை'
      },
      'Fixed Partial Denture': {
        intro: 'நிலையான பகுதி செயற்கை பல் (Fixed Partial Denture) பிரிவு',
        dept1: 'நிலையான பகுதி செயற்கை பல் மருத்துவத்துறையின்',
        dept2: 'செயற்கைப் பல்',
        dept3: 'செயற்கை பல் மருத்துவக் குழுவை'
      },
      'Partial Denture': {
        intro: 'பகுதி செயற்கை பல் (Partial Denture) பிரிவு',
        dept1: 'பகுதி செயற்கை பல் மருத்துவத்துறையின்',
        dept2: 'செயற்கைப் பல்',
        dept3: 'செயற்கை பல் மருத்துவக் குழுவை'
      },
      'Complete Denture': {
        intro: 'முழு செயற்கை பல் (Complete Denture) பிரிவு',
        dept1: 'முழு செயற்கை பல் மருத்துவத்துறையின்',
        dept2: 'செயற்கைப் பல்',
        dept3: 'செயற்கை பல் மருத்துவக் குழுவை'
      },
      'Prosthodontics': {
        intro: 'செயற்கை பல் கட்டும் பிரிவு',
        dept1: 'செயற்கை பல் கட்டும் மருத்துவத்துறையின்',
        dept2: 'செயற்கைப் பல்',
        dept3: 'செயற்கை பல் மருத்துவக் குழுவை'
      }
    };
    return textMap[dept] || textMap['Prosthodontics'];
  };

  const consentText = getDepartmentConsentText(departmentLabel);
...
<body>
  ...
  <p style="font-size:15px;line-height:1.7;color:#444;text-align:justify;margin-bottom:16px;">
    ஆகிய நான், இராமபுரம், எஸ்.ஆர்.எம். பல் மருத்துவக் கல்லூரியில் ${consentText.intro} மருத்துவர்களுக்கு முழு மனதுடன் எழுதிக்கொடுக்கும் சம்மதப்படிவம்.
  </p>

  <div class="consent-box">
    <p>${consentText.dept1} சிகிச்சைப் பற்றி அனைத்து விவரங்களையும் அதற்கான சிகிச்சைக் காலம், எத்தனை முறை சிகிச்சைக்கு வரவேண்டும், அதற்குண்டான கட்டணம், தேவையான இதர பல் சிகிச்சைகள் மற்றும் முன்காப்பு பின் விளைவுகள் பற்றி விவரமாக என்னிடம் தெரிவிக்கப்பட்டது.</p>
    <p style="margin-top:10px">சிகிச்சை காலத்தில் ஏற்படக்கூடிய சிகிச்சை மாற்றங்களை தெளிவாக விளக்கப்பட்டது. ${consentText.dept2} சிகிச்சைக்கான காலம் மற்றும் சிகிச்சைக் கட்டணம் தோராயமாகக் கூறப்பட்டது.</p>
    <p style="margin-top:10px;font-weight:bold;color:#222;">இந்த பல் சிகிச்சையினால் எனக்கு ஏற்படக்கூடிய, தவிர்க்க முடியாத பின் விளைவுகளுக்கு ${consentText.dept3} காரணமாக சொல்ல மாட்டேன் என்று உறுதியாக கூறுகிறேன்.</p>
  </div>
      ...
      <div style={styles.card}>
        ...
        <form onSubmit={handleSubmit} style={styles.formBody}>
          ...
          <div style={styles.consentBox}>
            <p>{consentText.dept1} சிகிச்சைப் பற்றி அனைத்து விவரங்களையும் அதற்கான சிகிச்சைக் காலம், எத்தனை முறை சிகிச்சைக்கு வரவேண்டும், அதற்குண்டான கட்டணம், தேவையான இதர பல் சிகிச்சைகள் மற்றும் முன்காப்பு பின் விளைவுகள் பற்றி விவரமாக என்னிடம் தெரிவிக்கப்பட்டது.</p>
            <p style={{ marginTop: "10px" }}>சிகிச்சை காலத்தில் ஏற்படக்கூடிய சிகிச்சை மாற்றங்களை தெளிவாக விளக்கப்பட்டது. {consentText.dept2} சிகிச்சைக்கான காலம் மற்றும் சிகிச்சைக் கட்டணம் தோராயமாகக் கூறப்பட்டது.</p>
            <p style={{ marginTop: "10px", fontWeight: "bold", color: "#222" }}>இந்த பல் சிகிச்சையினால் எனக்கு ஏற்படக்கூடிய, தவிர்க்க முடியாத பின் விளைவுகளுக்கு {consentText.dept3} காரணமாக சொல்ல மாட்டேன் என்று உறுதியாக கூறுகிறேன்.</p>
          </div>
